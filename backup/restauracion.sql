...
WITH 
    MOVE 'HotelEstrellaDelValle_Data' TO 'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\HotelEstrellaDelValle_RESTORED.mdf', 
    -- Ajusta la ruta a tu carpeta de DATA de SQL Server
    MOVE 'HotelEstrellaDelValle_Log' TO 'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\HotelEstrellaDelValle_RESTORED_Log.ldf', 
    -- Ajusta la ruta a tu carpeta de DATA de SQL Server
